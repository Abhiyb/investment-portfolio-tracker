...
<template>
    <div
        class="px-8 h-screen py-20 md:px-12 lg:px-20 flex items-center justify-center backdrop-blur-3xl !bg-cover bg-white !bg-center !bg-no-repeat"
    >
        <div class="px-8 md:px-12 lg:px-20 py-12 flex flex-col items-center gap-6 w-full max-w-xl backdrop-blur-2xl rounded-2xl bg-white/10 border border-black/10">
            <div class="flex flex-col items-center gap-4 w-full">
                ...
                <img class=" w-43 m-1 top-[-15px] absolute r-0" src="../assets/logo-transparent.png"/>
                <div class="flex flex-col gap-2 w-full">
                    <div class="text-center text-3xl font-medium text-black leading-tight">Get Started with Z-in</div>
                    <div class="text-center">
                        <span class="text-black/80">Already have an account? </span>
                        <a :onclick="()=>router.push('/login')" class="text-black/80 cursor-pointer hover:text-black/90 underline">Sign In</a>
                    </div>
                </div>
            </div>
            <div class="flex flex-col items-center gap-8 w-full">
                <div class="flex flex-col gap-6 w-full">
                    <IconField>
                        ...
                        <InputText
                            ...
                            type="text"
                            class="!appearance-none w-full !border !border-black/10  !outline-0 !bg-white/10 !text-black placeholder:!text-black/70 !shadow-sm"
                            placeholder="Name"
                        />
                    </IconField>
                    <IconField>
                ...
                <Button style=" background-color: #1A73E8;" :onclick="handleRegister" label="Sign Up" class="!w-full !bg-surface-950 !border !border-surface-950 !text-white hover:!bg-surface-950/80" />
            </div>
