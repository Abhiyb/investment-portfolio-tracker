...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                // Enable CORS with default configuration (will use corsConfigurationSource bean)
                .cors(Customizer.withDefaults())

                // Enable HTTP Basic authentication (not often used in production, but okay for testing or simple APIs)
                .httpBasic(Customizer.withDefaults())

                // Configure session management to be stateless (no HTTP session will be created or used)
